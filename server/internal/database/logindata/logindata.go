...
func (d *LoginDataStore) Create(ctx context.Context, loginData logindata.LoginData) error {
	...
	_, err := d.db.ExecContext(ctx, "INSERT INTO logindata (uuid, created, login, password, meta, user_id,) VALUES($1,$2,$3,$4,$5,$6)", loginData.UUID.String(), loginData.Created, loginData.Login, loginData.Password, loginData.Meta, loginData.UserID)
...
func (d *LoginDataStore) Update(ctx context.Context, loginDataUID, newpassword string) error {
